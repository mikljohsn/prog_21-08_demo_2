package com.example.prog_2108_demo_2.Config;
...
public class DataSetup implements ApplicationRunner {
    //@Autowired --- kan bruges til at lave instanserne, men den brokker sig
    PlayerRepository playerRepository;

    public DataSetup(PlayerRepository playerRepository) { //constructor injection -- laver instansen uden brok
